<?php
/**
 * Ready Set Funds: Color Patterns
 *
 * @package WordPress
 ...
 */
function readysetfunds_custom_colors_css() {
	...
	/**
	 * Filter Ready Set Funds default saturation level.
	 *
	 * @since Ready Set Funds 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'readysetfunds_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter Ready Set Funds default selection saturation level.
	 *
	 * @since Ready Set Funds 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'readysetfunds_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter Ready Set Funds default lightness level.
	 *
	 * @since Ready Set Funds 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'readysetfunds_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter Ready Set Funds default hover lightness level.
	 *
	 * @since Ready Set Funds 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'readysetfunds_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter Ready Set Funds default selection lightness level.
	 *
	 * @since Ready Set Funds 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'readysetfunds_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters Ready Set Funds custom colors CSS.
	 *
	 * @since Ready Set Funds 1.0
	 *
	 ...
	 */
	return apply_filters( 'readysetfunds_custom_colors_css', $theme_css, $primary_color, $saturation );
}
