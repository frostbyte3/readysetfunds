...
<head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/assets/css/discovery.css">
            ...
            <div class="banner about_banner">
                <div class="banner-text-wrap">
                    <div class="banner-text">
                        <h1 class="title">ReadySetFunds Learning Center</h1>
                        <div class="after_tick" style="width: 200px"></div>
                        <p class="title_text">This is the one stop shop where you can learn everything you need to know about how to get your business to it's full potential!</p>
                    </div>
                </div>
            </div>
        </header>
